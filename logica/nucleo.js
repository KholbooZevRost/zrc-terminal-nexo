        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    log_sistema_nexo.scrollTop = log_sistema_nexo.scrollHeight;
                    setTimeout(() => {
                        log_sistema_nexo.innerHTML += `<span style="color: #33ff66; opacity: 0.45;">> SYS_MUTEX_LOCK: ⚙ ⎈ [EXCLUSIÓN_MUTUA_INYECTADA] ... MONITOR ESTABLE.</span><br>`;
                        log_sistema_nexo.innerHTML += `<span style="color: #33ff66; opacity: 0.45;">> REANUDANDO INSTALACIÓN DEL REPOSITORIO VANGUARDIA...</span><br>`;
                        log_sistema_nexo.scrollTop = log_sistema_nexo.scrollHeight;
                        error_resuelto = true; 
                    }, 1200); 
                }, 800); 
